...
for menor que 3, arredondar a nota para esse próximo múltiplo de 5. Se a nota for abaixo de 38,
...
Por exemplo, a nota 84 será arredondada para 85, mas a nota 29 não será arredondada por ser abaixo
 de 40 e não ser possível arredondamento eficiente,
...
function notas (nota){
    ...
    if ((proximoMultiplo - nota) < 3){
        ...
        console.log(`Nota arredondada. Você foi aprovado com ${proximoMultiplo}`)
    }else if ((proximoMultiplo - nota) > 3 && (proximoMultiplo - nota) > 40){
        nota = proximoMultiplo;
        console.log(`Nota arredondada. Você foi aprovado com ${proximoMultiplo}`)
    }else {
